...
一本写 Claude Code 的中文随笔，**二十八章，外加一篇尾声**。从「它是什么」讲起，一路讲到你怎么照自己的需要养出一只怪兽。书里的命令和说法都对着 [code.claude.com](https://code.claude.com/docs/en/overview) 的官方文档核过；至于讲法，仍是闲谈的路子，不端着。
...
- **新功能**（22–28）：Web/桌面/手机、Routines 定时任务、自动记忆、远程操控、Code Review、Agent SDK、Loop 工程
